...
{/* Top Header — desktop */}
  <header className='flex items-center justify-between px-6 py-3 border-b border-white/10'>
    ...
    <button
      ...
      className='flex cursor-pointer items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium text-white/50 hover:bg-red-500/10 hover:text-red-400 transition border border-white/10'
    >
